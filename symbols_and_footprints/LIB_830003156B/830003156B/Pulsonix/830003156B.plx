...
(library Library_1
	...
	(patternDef "830003156B" (originalName "830003156B")
		...
		(layerContents (layerNumRef 28)
			(arc (pt -0.66, 0) (radius 2.35) (startAngle 90.0) (sweepAngle 180.0) (width 0.025))
		)
		(layerContents (layerNumRef 28)
		...
		(layerContents (layerNumRef 28)
			(arc (pt 5.54, 0) (radius 2.35) (startAngle 270) (sweepAngle 180.0) (width 0.025))
		)
		(layerContents (layerNumRef 28)
	...
	(compDef "830003156B" (originalName "830003156B") (compHeader (numPins 2) (numParts 1) (refDesPrefix Y)
		...
		(attr "<Hyperlink>" "https://www.we-online.com/catalog/datasheet/830003156B.pdf")
		(attr "<Component Height>" "4.1")
		(attr "<STEP Filename>" "830003156B.stp")
